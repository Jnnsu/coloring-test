...
import { BrushSettingArea } from '@/components/Coloring/ColoringToolbar/BrushSettingArea';
import { ColorPalette } from '@/components/Coloring/ColoringToolbar/ColorPalette';
